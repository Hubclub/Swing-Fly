...
public class Constants {
	...
	public static final float FLY_HEIGHT = 60*HEIGHT_RATIO;
	...
	public static final float COZMA = 24 * WIDTH_RATIO;
	public static final float FONT_SIZE = 1.5f * WIDTH_RATIO;
